    ...
    <div className="w-80 h-full border-l border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/80 flex flex-col overflow-y-auto transition-colors">
      ...
      <div className="px-5 py-4 border-b border-slate-200 dark:border-slate-800 shrink-0">
        <div className="flex items-start justify-between">
          ...
          <button
            onClick={onClose}
            className="ml-2 p-1 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors text-slate-400 hover:text-slate-600 dark:hover:text-slate-300"
          >
            ...
            <div className="flex items-center gap-3 mt-3 pt-3 border-t border-purple-200/50 dark:border-purple-500/15">
              <div className="flex items-center gap-1.5">
                <div
                  ...
                  style={{
                    background: aiSummary.trend === 'improving' ? '#22c55e'
                      : aiSummary.trend === 'declining' ? '#ef4444' : '#f59e0b',
                  }}
                />
              ...
              <div className="flex items-center gap-1.5">
                <div
                  className="w-2 h-2 rounded-full"
                  style={{
                    background: aiSummary.riskLevel === 'safe' ? '#22c55e'
                      : aiSummary.riskLevel === 'moderate' ? '#f59e0b' : '#ef4444',
                  }}
                />
